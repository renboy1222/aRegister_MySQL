...
import com.aldrin.aregister.gui.dialog.au.JDialogStudentAU;
...
public class JDialogStudent extends javax.swing.JDialog implements MouseListener {
    ...
    public JDialogStudent(JFrameRegister jFrameRegister, boolean modal) {
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(1250, 563));
        setLocationRelativeTo(null);
    }// </editor-fold>//GEN-END:initComponents

    private void jButtonNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonNewActionPerformed
        JDialogStudentAU roleAU = new JDialogStudentAU(jFrameRegister, true);
        roleAU.setVisible(true);
        selectStudent();
    }//GEN-LAST:event_jButtonNewActionPerformed

    private void jButtonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUpdateActionPerformed
        JDialogStudentAU roleAU = new JDialogStudentAU(jFrameRegister, true, student, "Update");
        roleAU.setVisible(true);
        selectStudent();
        jButtonDelete.setEnabled(false);
        jButtonUpdate.setEnabled(false);
    ...
    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteActionPerformed
        JDialogStudentAU roleAU = new JDialogStudentAU(jFrameRegister, true, "Delete", student);
        roleAU.setVisible(true);
        selectStudent();
        jButtonDelete.setEnabled(false);
        jButtonUpdate.setEnabled(false);
...
public DefaultTableModel tableModel = new DefaultTableModel(new Object[]{"ID", "COURSE ID", "CIVIL STATUS ID", "CITIZENSHIP ID","STUDENT ID", "FIRST NAME", "MIDDLE NAME", "SURNAME", "COURSE", "CIVIL STATUS", "GENDER", "DATE OF BIRTH", "CITIZENSHIP", "MOBILE", "EMAIL", "ADDRESS"}, 0) {
    ...
    private void setTable() {
        ...
        TableColumn hide2 = jTableStudent.getColumnModel().getColumn(2);
        hide2.setMinWidth(0);
        hide2.setMaxWidth(0);
        hide2.setPreferredWidth(0);
        TableColumn hide3 = jTableStudent.getColumnModel().getColumn(3);
        hide3.setMinWidth(0);
        hide3.setMaxWidth(0);
...
//    "GENDER", "DATE OF BIRTH", "CITIZENSHIP", "MOBILE", "EMAIL", "ADDRESS"
                        Long id = Long.parseLong(jTableStudent.getValueAt(row, 0).toString());
                        Long courseId = Long.parseLong(jTableStudent.getValueAt(row, 1).toString());
                        Long civiStatusId = Long.parseLong(jTableStudent.getValueAt(row, 2).toString());
                        Long citizenshipId = Long.parseLong(jTableStudent.getValueAt(row, 3).toString());
                        String studentID = jTableStudent.getValueAt(row, 4).toString();
                        String firstname = jTableStudent.getValueAt(row, 5).toString();
                        String middlename = jTableStudent.getValueAt(row, 6).toString();
                        String surname = jTableStudent.getValueAt(row, 7).toString();
                        String gender =jTableStudent.getValueAt(row, 10).toString();
                        String dateOfBirth =jTableStudent.getValueAt(row, 11).toString();
                        String mobile =jTableStudent.getValueAt(row, 13).toString();
                        String email =jTableStudent.getValueAt(row, 14).toString();
                        String address =jTableStudent.getValueAt(row, 15).toString();
                        Course course = new Course();
                        CivilStatus civilStatus = new CivilStatus();
                        Citizenship citizenship = new Citizenship();
                        
                        course.setId(courseId);
                        civilStatus.setId(civiStatusId);
                        ...
                        Student s = studentDAOImpl.findPhotoByStudentId(student);
...
//    "GENDER", "DATE OF BIRTH", "CITIZENSHIP", "MOBILE", "EMAIL", "ADDRESS"
    ...
    private void selectStudent() {
        ...
        studentList = studentDAOImpl.selectStudent();
        tableModel.setRowCount(0);
        for (Student c : studentList) {
            tableModel.addRow(new Object[]{c.getId(), c.getCourse().getId(), c.getCivilStatus().getId(),
                c.getCitizenship().getId(),c.getStudentId(), c.getFirstname(), c.getMiddlename(), c.getSurname(), c.getCourse().getCourse(),
                c.getCivilStatus().getCivilStatus(), c.getGender(), c.getDateOfBirth(), c.getCitizenship().getCitizenship(), c.getMobileNo(), c.getEmail(), c.getAddress()});
        }
    }
