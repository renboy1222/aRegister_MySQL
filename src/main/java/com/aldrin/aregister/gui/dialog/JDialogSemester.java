...
import com.aldrin.aregister.gui.dialog.au.JDialogSemesterAU;
...
public class JDialogSemester extends javax.swing.JDialog implements MouseListener {
    ...
    public JDialogSemester(JFrameRegister jFrameRegister, boolean modal) {
    ...
    private void initComponents() {
        ...
        jTableSemester = new javax.swing.JTable();
        ...
        jTableSemester.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(jTableSemester);
    ...
    private void jButtonNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonNewActionPerformed
        JDialogSemesterAU semesterAU = new JDialogSemesterAU(jFrameRegister, true);
        semesterAU.setVisible(true);
        selectSemester();
    }//GEN-LAST:event_jButtonNewActionPerformed

    private void jButtonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUpdateActionPerformed
        JDialogSemesterAU semesterAU = new JDialogSemesterAU(jFrameRegister, true, semester, "Update");
        semesterAU.setVisible(true);
        selectSemester();
        jButtonDelete.setEnabled(false);
        jButtonUpdate.setEnabled(false);
    ...
    private javax.swing.JTable jTableSemester;
    private javax.swing.JTextField jTextFieldSearch;
    // End of variables declaration//GEN-END:variables
  DefaultTableModel tableModel = new DefaultTableModel(new Object[]{"ID", "SEMESTER"}, 0);

    private TableRowSorter<TableModel> sorter = new TableRowSorter<TableModel>(tableModel);

    private void setTable() {
        jTableSemester.setCellSelectionEnabled(true);
        jTableSemester = new JTable(tableModel);
        jScrollPane1.setViewportView(jTableSemester);
        jTableSemester.addMouseListener(this);
        jTableSemester.setRowSorter(sorter);
        TableColumn hide0 = jTableSemester.getColumnModel().getColumn(0);
        hide0.setMinWidth(0);
        hide0.setMaxWidth(0);
        hide0.setPreferredWidth(0);

        TableColumn[] column = new TableColumn[100];
        column[1] = jTableSemester.getColumnModel().getColumn(1);
    ...
    private void selectSemester() {
        ...
        semesterList = semesterDAOImpl.selectSemester();
        tableModel.setRowCount(0);
        for (Semester d : semesterList) {
            tableModel.addRow(new Object[]{d.getId(), d.getSemester()});
        }
    ...
    public void mouseClicked(MouseEvent e) {
        if (e.getSource() == jTableSemester) {
            if (e.getButton() == MouseEvent.BUTTON1) {
                if (e.getClickCount() == 1) {
                    int row = jTableSemester.getSelectedRow();
                    if (row != -1) {
                        Long userId = Long.parseLong(jTableSemester.getValueAt(row, 0).toString());
                        String day = jTableSemester.getValueAt(row, 1).toString();
