...
import com.aldrin.aregister.gui.dialog.au.JDialogSubjectAU;
...
public class JDialogSubject extends javax.swing.JDialog implements MouseListener {
    ...
    public JDialogSubject(JFrameRegister jFrameRegister, boolean modal) {
    ...
    private void jButtonNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonNewActionPerformed
        JDialogSubjectAU subjectAU = new JDialogSubjectAU(jFrameRegister, true);
        subjectAU.setVisible(true);
        selectCategory();
    }//GEN-LAST:event_jButtonNewActionPerformed

    private void jButtonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUpdateActionPerformed
        JDialogSubjectAU categoryAU = new JDialogSubjectAU(jFrameRegister, true, subject, "Update");
  ...
  DefaultTableModel tableModel = new DefaultTableModel(new Object[]{"ID", "CODE", "SUBJECT", "UNIT"}, 0);
    ...
    private void setTable() {
        ...
        column[2].setPreferredWidth(380);
    ...
    private void selectCategory() {
        ...
        for (Subject s : subjectList) {
            tableModel.addRow(new Object[]{s.getId(), s.getCode(), s.getSubject(), s.getUnit()});
        }
            ...
            if (e.getButton() == MouseEvent.BUTTON1) {
                if (e.getClickCount() == 1) {
                    ...
                    if (row != -1) {
                        ...
                        String code = jTableSubject.getValueAt(row, 1).toString();
                        String subject = jTableSubject.getValueAt(row, 2).toString();
                        Integer unit = Integer.parseInt(jTableSubject.getValueAt(row, 3).toString());
