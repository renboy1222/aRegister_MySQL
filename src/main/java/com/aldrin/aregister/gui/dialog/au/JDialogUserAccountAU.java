...
import com.aldrin.aregister.dao.impl.RoleDAOImpl;
...
public class JDialogUserAccountAU extends javax.swing.JDialog {
    ...
    public JDialogUserAccountAU(JFrameRegister jFrameRegister, boolean modal) {
    ...
    public JDialogUserAccountAU(JFrameRegister jFrameRegister, boolean modal, UserAccount userAccount, String title) {
        super(jFrameRegister, modal);
        initComponents();
    ...
    public JDialogUserAccountAU(JFrameRegister jFrameRegister, boolean modal, String title, UserAccount userAccount) {
        super(jFrameRegister, modal);
        initComponents();
