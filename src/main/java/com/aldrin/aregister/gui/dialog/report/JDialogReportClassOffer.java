 ...
 * @author ALRIN B.C.
 */
public class JDialogReportClassOffer extends javax.swing.JDialog implements ActionListener {
    ...
    public JDialogReportClassOffer(JFrameRegister jFrameSariPOS, boolean modal) {
    ...
    private void initComponents() {
        ...
        jPanel3.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 100, 30));

        jPanel3.add(jComboBoxSchoolYear, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 10, 320, 30));
...
//
    ...
    public void showReport() {
        ...
        try {
            ...
            con.getDBConn();
            String fullPath = System.getProperty("user.dir") + "/src/main/resources/reports/subjectOffer.jasper";
            Map<String, Object> param = new HashMap<String, Object>();

            ComboBoxList studentId = (ComboBoxList) this.jComboBoxSchoolYear.getSelectedItem();
            Student student = new Student();
            student.setId(studentId.getId());
            param.put("SYID", student.getId());
