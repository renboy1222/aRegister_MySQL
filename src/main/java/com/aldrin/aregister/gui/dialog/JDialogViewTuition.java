 ...
 * @author ALRIN B.C.
 */
public class JDialogViewTuition extends javax.swing.JDialog implements ActionListener, MouseListener {
    ...
    public JDialogViewTuition(JFrameRegister jFrameRegister, boolean modal) {
    ...
    public DefaultTableModel tableModel = new DefaultTableModel(new Object[]{"STUDENT ID", "SURNAME", "FIRST NAME", "MIDDLE NAME", "GENDER", "CIVIL STATUS", "CITIZENSHIP", "COURSE", "UNITS"}, 0) {
...
//"STUDENT ID", "SURNAME", "FIRST NAME", "MIDDLE NAME", "GENDER", "CIVIL STATUS", "CITIZENSHIP", "COURSE","UNITS"
    ...
    private void selectEnrolledStudents(Long schoolYear) {
        ...
        for (ClassEnroll ce : classEnrollList) {
            tableModel.addRow(new Object[]{ce.getStudent().getId(), ce.getStudent().getSurname(), ce.getStudent().getFirstname(),
