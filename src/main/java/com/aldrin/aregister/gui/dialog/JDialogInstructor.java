...
import com.aldrin.aregister.gui.dialog.au.JDialogInstructorAU;
...
//    private Role role;
    ...
    public JDialogInstructor(JFrameRegister jFrameRegister, boolean modal) {
...
public DefaultTableModel tableModel = new DefaultTableModel(new Object[]{"ID",  "CIVIL STATUS ID", "CITIZENSHIP ID", "FIRST NAME", "MIDDLE NAME", "SURNAME", "CIVIL STATUS", "GENDER", "DATE OF BIRTH", "CITIZENSHIP", "MOBILE", "EMAIL", "ADDRESS"}, 0) {
    ...
    private void setTable() {
        ...
        TableColumn hide2 = jTableInstructor.getColumnModel().getColumn(2);
        hide2.setMinWidth(0);
        hide2.setMaxWidth(0);
        ...
        if (e.getSource() == jTableInstructor) {
            if (e.getButton() == MouseEvent.BUTTON1) {
                if (e.getClickCount() == 1) {
                    ...
                    if (row != -1) {
//    "ID",  "CIVIL STATUS ID", "CITIZENSHIP ID", "FIRST NAME", "MIDDLE NAME", "SURNAME",  "CIVIL STATUS",
//    "GENDER", "DATE OF BIRTH", "CITIZENSHIP", "MOBILE", "EMAIL", "ADDRESS"
                        Long id = Long.parseLong(jTableInstructor.getValueAt(row, 0).toString());
                        Long civiStatusId = Long.parseLong(jTableInstructor.getValueAt(row, 1).toString());
                        Long citizenshipId = Long.parseLong(jTableInstructor.getValueAt(row, 2).toString());
                        String firstname = jTableInstructor.getValueAt(row, 3).toString();
                        String middlename = jTableInstructor.getValueAt(row, 4).toString();
                        String surname = jTableInstructor.getValueAt(row, 5).toString();
                        String gender =jTableInstructor.getValueAt(row, 7).toString();
                        String dateOfBirth =jTableInstructor.getValueAt(row, 8).toString();
                        String mobile =jTableInstructor.getValueAt(row, 9).toString();
                        String email =jTableInstructor.getValueAt(row, 10).toString();
                        String address =jTableInstructor.getValueAt(row, 11).toString();
                        ...
                        instructor.setMobileNo(mobile);
                        instructor.setEmail(email);
                        instructor.setAddress(address);
                        instructor.setCivilStatus(civilStatus);
                        instructor.setCitizenship(citizenship);
                        Instructor s = instructorDAOImpl.findPhotoByInstructorId(instructor);
                        instructor.setPhoto(s.getPhoto());
...
//    "GENDER", "DATE OF BIRTH", "CITIZENSHIP", "MOBILE", "EMAIL", "ADDRESS"
    ...
    private void selectStudent() {
        ...
        for (Instructor i : instructorList) {
            tableModel.addRow(new Object[]{i.getId(), i.getCivilStatus().getId(),
                i.getCitizenship().getId(), i.getFirstname(), i.getMiddlename(), i.getSurname(), 
                i.getCivilStatus().getCivilStatus(), i.getGender(), i.getDateOfBirth(), i.getCitizenship().getCitizenship(), i.getMobileNo(), i.getEmail(), i.getAddress()});
        }
    }
