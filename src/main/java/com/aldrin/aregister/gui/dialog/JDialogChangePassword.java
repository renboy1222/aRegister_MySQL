...
public class JDialogChangePassword extends javax.swing.JDialog {
     ...
     */
    public JDialogChangePassword(com.aldrin.aregister.gui.JFrameRegister parent, boolean modal, UserAccount userAccount) {
        super(parent, modal);
        initComponents();
        this.jFrameRegister = parent;
    ...
    private void jPasswordFieldReTypeNewPasswordKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jPasswordFieldReTypeNewPasswordKeyReleased
        if (jPasswordFieldNewPassword.getText().toString().equals(jPasswordFieldReTypeNewPassword.getText().toString())) {
            jPasswordFieldReTypeNewPassword.putClientProperty("JComponent.outline", "success");
            jPasswordFieldNewPassword.putClientProperty("JComponent.outline", "success");
            setReTypePassword(true);
            validateFields();
            jLabelErrorMessage.setText("");
        } else {
    ...
    private void jButtonChangePasswordActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonChangePasswordActionPerformed
        ...
        int response = JOptionPane.showConfirmDialog(jFrameRegister, "Are you sure to change your password?", "Change password confirmation", JOptionPane.YES_NO_OPTION);
        if (response == JOptionPane.YES_OPTION) {
            if (userAccountDAOImpl.changePassword(userAccount) == true) {
                JOptionPane.showMessageDialog(jFrameRegister, "Password is successfully change.", "Message", JOptionPane.PLAIN_MESSAGE);
                this.dispose();
            }
        }
