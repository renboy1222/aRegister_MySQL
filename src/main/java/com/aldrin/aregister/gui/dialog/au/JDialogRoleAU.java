...
public class JDialogRoleAU extends javax.swing.JDialog {
    ...
    public JDialogRoleAU(JFrameRegister jFrameRegister, boolean modal) {
    ...
    public JDialogRoleAU(JFrameRegister jFrameRegister, boolean modal, Role role, String title) {
        super(jFrameRegister, modal);
        initComponents();
        getRootPane().putClientProperty(FlatClientProperties.TITLE_BAR_BACKGROUND, new Color(187, 187, 187));
        setTitle(title);
    ...
    public JDialogRoleAU(JFrameRegister jFrameRegister, boolean modal, String title, Role role) {
        super(jFrameRegister, modal);
        initComponents();
        getRootPane().putClientProperty(FlatClientProperties.TITLE_BAR_BACKGROUND, new Color(187, 187, 187));
        setTitle(title);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (this.title.equals("New")) {
            int response = JOptionPane.showConfirmDialog(jFrameRegister, "Are you sure to save " + jTextFieldRole.getText() + " ?", "Save confirmation", JOptionPane.YES_NO_OPTION);
            ...
            int response = JOptionPane.showConfirmDialog(jFrameRegister, "Are you sure to update " + jTextFieldRole.getText() + " ?", "Save confirmation", JOptionPane.YES_NO_OPTION);
            if (response == JOptionPane.YES_OPTION) {
                this.role.setRole(jTextFieldRole.getText());
                this.role.setDescription(jTextFieldDescription.getText());
            ...
            int response = JOptionPane.showConfirmDialog(jFrameRegister, "Are you sure to delete " + jTextFieldRole.getText() + " ?", "Save confirmation", JOptionPane.YES_NO_OPTION);
            if (response == JOptionPane.YES_OPTION) {
