...
import com.aldrin.aregister.gui.dialog.au.JDialogCourseAU;
...
public class JDialogCourse extends javax.swing.JDialog implements MouseListener {
    ...
    public JDialogCourse(JFrameRegister jFrameRegister, boolean modal) {
    ...
    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteActionPerformed
        JDialogCourseAU categoryAU = new JDialogCourseAU(jFrameRegister, true, "Delete", category);
        categoryAU.setVisible(true);
        jButtonDelete.setEnabled(false);
        jButtonUpdate.setEnabled(false);
  ...
  DefaultTableModel tableModel = new DefaultTableModel(new Object[]{"ID", "COURSE", "ACRONYM"}, 0);
    ...
    private void setTable() {
        ...
        column[2] = jTableCourse.getColumnModel().getColumn(2);
    ...
    private void selectCourse() {
        ...
        for (Course c : courseList) {
            tableModel.addRow(new Object[]{c.getId(), c.getCourse(), c.getAcronym()});
        }
