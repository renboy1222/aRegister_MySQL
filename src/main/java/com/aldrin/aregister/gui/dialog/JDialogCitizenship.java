...
import com.aldrin.aregister.gui.dialog.au.JDialogCitizenshipAU;
 ...
 * @author ALDRIN B. C.
 */
public class JDialogCitizenship extends javax.swing.JDialog implements MouseListener {
    ...
    public JDialogCitizenship(JFrameRegister jFrameRegister, boolean modal) {
    ...
    private void initComponents() {
        ...
        jTableCitizenship = new javax.swing.JTable();
        ...
        setTitle("CITIZENSHIP");

        jPanel1.setLayout(new java.awt.BorderLayout());

        jPanel5.setLayout(new java.awt.BorderLayout());

        jTableCitizenship.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(jTableCitizenship);
    ...
    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteActionPerformed
        JDialogCitizenshipAU  semesterAU = new JDialogCitizenshipAU (jFrameRegister, true, "Delete", citizenship);
        semesterAU.setVisible(true);
        jButtonDelete.setEnabled(false);
        jButtonUpdate.setEnabled(false);
    ...
    private javax.swing.JTable jTableCitizenship;
    private javax.swing.JTextField jTextFieldSearch;
    // End of variables declaration//GEN-END:variables
  DefaultTableModel tableModel = new DefaultTableModel(new Object[]{"ID", "CITIZENSHIP"}, 0);

    private TableRowSorter<TableModel> sorter = new TableRowSorter<TableModel>(tableModel);

    private void setTable() {
        jTableCitizenship.setCellSelectionEnabled(true);
        jTableCitizenship = new JTable(tableModel);
        jScrollPane1.setViewportView(jTableCitizenship);
        jTableCitizenship.addMouseListener(this);
        jTableCitizenship.setRowSorter(sorter);
        TableColumn hide0 = jTableCitizenship.getColumnModel().getColumn(0);
        hide0.setMinWidth(0);
        hide0.setMaxWidth(0);
        hide0.setPreferredWidth(0);

        TableColumn[] column = new TableColumn[100];
        column[1] = jTableCitizenship.getColumnModel().getColumn(1);
    ...
    private void selectCitizenship() {
        ...
        tableModel.setRowCount(0);
        for (Citizenship d : citizenshipList) {
            tableModel.addRow(new Object[]{d.getId(), d.getCitizenship()});
        }
    ...
    public void mouseClicked(MouseEvent e) {
        if (e.getSource() == jTableCitizenship) {
            if (e.getButton() == MouseEvent.BUTTON1) {
                if (e.getClickCount() == 1) {
                    int row = jTableCitizenship.getSelectedRow();
                    if (row != -1) {
                        Long userId = Long.parseLong(jTableCitizenship.getValueAt(row, 0).toString());
                        String day = jTableCitizenship.getValueAt(row, 1).toString();
                        Citizenship c = new Citizenship();
                        c.setId(userId);
                        c.setCitizenship(day);
                        this.citizenship = c;
