 ...
 * @author ALRIN B.C.
 */
public class JDialogSchoolYearTuition extends javax.swing.JDialog implements ActionListener, MouseListener {
    ...
    public JDialogSchoolYearTuition(JFrameRegister jFrameRegister, boolean modal) {
    ...
    private void initComponents() {
        ...
        jTextFieldTotalTuition = new javax.swing.JTextField();
        jPanel31 = new javax.swing.JPanel();
        jPanel32 = new javax.swing.JPanel();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setTitle("SCHOOL YEAR TUITION");
        ...
        jPanel30.add(jButtonPrint, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 20, 90, 30));

        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel1.setText("TOTAL TUITION FEE:");
        jLabel1.setHorizontalTextPosition(javax.swing.SwingConstants.LEFT);
        jPanel30.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(890, 20, 130, 30));

        jTextFieldTotalTuition.setEditable(false);
        jTextFieldTotalTuition.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jTextFieldTotalTuition.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        jPanel30.add(jTextFieldTotalTuition, new org.netbeans.lib.awtextra.AbsoluteConstraints(1040, 20, 160, 30));
    ...
    private javax.swing.JTextField jTextFieldTotalTuition;
    // End of variables declaration//GEN-END:variables

    public DefaultTableModel tableModel = new DefaultTableModel(new Object[]{"#", "SURNAME", "FIRST NAME", "MIDDLE NAME", "GENDER", "TOTAL UNITS", "TUITION FEE/UNIT", "TUITION FEE/UNIT UF", "TOTAL TUITION", "TOTAL TUITION FEE UF"}, 0) {
...
//        hide0.setPreferredWidth(0);
        TableColumn hide7 = jTableInstructor.getColumnModel().getColumn(7);
        hide7.setMinWidth(0);
        hide7.setMaxWidth(0);
        hide7.setPreferredWidth(0);
        TableColumn hide9 = jTableInstructor.getColumnModel().getColumn(9);
        hide9.setMinWidth(0);
        hide9.setMaxWidth(0);
...
//"#", "SURNAME", "FIRST NAME", "MIDDLE NAME", "GENDER", "TOTAL UNITS", "TUITION FEE/UNIT", "TUITION FEE/UNIT UF","TOTAL TUITION","TOTAL TUITION FEE UF"

    private void selectEnrolledStudents(Long schoolYear) {
        tableModel.setRowCount(0);
        classEnrollList = classEnrollDAOImpl.selectTotalTuition(schoolYear);
        tableModel.setRowCount(0);
        for (ClassEnroll ce : classEnrollList) {
            tableModel.addRow(new Object[]{jTableInstructor.getRowCount() + 1, ce.getStudent().getSurname(), ce.getStudent().getFirstname(),
                ce.getStudent().getMiddlename(), ce.getStudent().getGender(), ce.getClassOffer().getSubject().getUnit(),
                df.format(ce.getClassOffer().getSchoolYear().getTuition().getTuitionFee()), ce.getClassOffer().getSchoolYear().getTuition().getTuitionFee(),
                df.format(ce.getClassOffer().getSchoolYear().getTuition().getTuitionFee() * ce.getClassOffer().getSubject().getUnit()),
                ce.getClassOffer().getSchoolYear().getTuition().getTuitionFee() * ce.getClassOffer().getSubject().getUnit()});
        }
    }
    ...
    public void autoPrint() {
        try {
            ...
            con.getDBConn();
            String fullPath = System.getProperty("user.dir") + "/src/main/resources/reports/syTuition.jasper";
...
//            JasperExportManager.exportReportToPdfFile(jp, "C:\\Users\\admin\\Desktop\\userSales.pdf");
    ...
    private void calculateTotalTuition() {
        Float total = 0.0f;
        for (int i = 0; i < jTableInstructor.getRowCount(); i++) {
            Float tuitionPerRow = Float.parseFloat(jTableInstructor.getValueAt(i, 9).toString());
            total = total + tuitionPerRow;
        }
        jTextFieldTotalTuition.setText(df.format(total));
