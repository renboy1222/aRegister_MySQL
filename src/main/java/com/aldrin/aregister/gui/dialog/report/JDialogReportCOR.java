 ...
 * @author ALRIN B.C.
 */
public class JDialogReportCOR extends javax.swing.JDialog implements ActionListener {
    ...
    public JDialogReportCOR(JFrameRegister jFrameSariPOS, boolean modal) {
        ...
        editor = (JTextComponent) jComboBoxStudent.getEditor().getEditorComponent();
        editor.setDocument(new ComboBoxAutoFill(jComboBoxStudent));
        jComboBoxSchoolYear.setEditable(true);
        jComboBoxStudent.addActionListener(this);
    ...
    private void initComponents() {
        ...
        jPanel3.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 10, 90, 30));

        jPanel3.add(jComboBoxStudent, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 10, 320, 30));

        jLabel2.setText("STUDENT:");
        jPanel3.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 60, 30));

        jPanel3.add(jComboBoxSchoolYear, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 10, 360, 30));
        ...
        setSize(new java.awt.Dimension(998, 598));
...
//
    ...
    public void showReport() {
        ...
        try {
            ...
            con.getDBConn();
            String fullPath = System.getProperty("user.dir") + "/src/main/resources/reports/corWSY.jasper";
            Map<String, Object> param = new HashMap<String, Object>();

            ComboBoxList studentId = (ComboBoxList) this.jComboBoxStudent.getSelectedItem();
            param.put("STUDENTID", studentId.getId());
            System.out.println("studentId:"+studentId.getId());
...
//            JasperExportManager.exportReportToPdfFile(jp, "C:\\Users\\admin\\Desktop\\userSales.pdf");
    ...
    public void actionPerformed(ActionEvent e) {
        try {
            if (e.getSource() == jComboBoxStudent) {
                showReport();
